...
<header>
    ...
    <div class="menu">
        <select onchange="location = this.value;">
            <option>Witaj <?php echo htmlspecialchars($_SESSION['login']); ?></option>
            <option value="komunikator.php">Komunikator</option>
            <option value="ustawienia.php">Ustawienia</option>
            <option value="wyloguj.php">Wyloguj się</option>
        </select>
    </div>
</header>
